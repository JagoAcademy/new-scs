        ...
        <div class="bg-white p-3 rounded-xl shadow-sm border border-slate-200 mb-3 overflow-hidden relative ${i === 0 || i === 2 ? 'border-amber-300 ring-1 ring-amber-100 transform hover:scale-[1.02]' : 'opacity-80'}">
            ...
            <div class="bg-slate-50/50 rounded-lg p-1.5 border border-slate-100">
                <div class="flex items-center py-1 px-1">
                    ...
                    <div class="flex-1 pl-1"><p class="text-[8px] font-black text-slate-800 uppercase truncate">Perenang Dummy 1</p></div>
