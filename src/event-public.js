...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    // ==========================================
    // LOGIKA LOGIN GOOGLE (MENGGUNAKAN GOOGLE IDENTITY SERVICES)
    // ==========================================
    ...
    if (btnGoogleLoginPublic) {
        ...
        btnGoogleLoginPublic.className = 'flex justify-center w-full mt-2 mb-4'; 
        ...
        const renderGoogleButton = () => {
            ...
            // 1. Inisialisasi Google Auth persis seperti auth.js
            ...
            // 2. Gambar tombol Google ke dalam DIV
    ...
    document.getElementById('btnLogout').addEventListener('click', async () => {
        ...
        window.location.reload(); // Reload halaman agar tampilan kembali jadi Guest
    });
